...
class TwoPlayerScreen extends StatefulWidget {
  ...
  const TwoPlayerScreen({Key? key, required this.firstPlayer,required this.secondPlayer}) : super(key: key);
                  ...
                  child: Column(
                    children: [
                      ...
                      (Provider.of<PlayerProvider>(context).activePlayer) == 'X'? Text(
                        'IT\'s ${widget.firstPlayer} turn'
                            .toUpperCase(),
                        style: TextStyle(fontSize: 30, color: Colors.black),
                      ) : Text(
                        'IT\'s ${widget.secondPlayer} turn'
                            .toUpperCase(),
                        style: TextStyle(fontSize: 30, color: Colors.black),
                      ) ,
                      SizedBox(height: 80),
                      ...
                      (playerProvider.gameOver && playerProvider.winner != "")
                        ...
                        child: (Provider.of<PlayerProvider>(context).activePlayer) == 'X'? Text(
                          '${'${widget.secondPlayer}' + " " + 'is the winner'}',
                          style: TextStyle(color: Colors.white, fontSize: 30,fontWeight: FontWeight.bold),
                        ) : Text(
                          '${widget.firstPlayer} is The Winner',
                          style: TextStyle(color: Colors.white, fontSize: 30,fontWeight: FontWeight.bold),
                        ) ,
                      )
